...
#### Download results: 
Download the Results.zip file from here: TODO: Add link, place it in the root directory and unzip it.
```bash
mkdir data
cd data
gdown [LINK COMING SOON]
unzip Results.zip
```

### Evaluation
Follow these instructions to reproduce the data shown in the evaluation section of the paper.
...
#### Figure 4 and 8 (parameters graphs)
